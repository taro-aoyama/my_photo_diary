...
module.exports = {
  ...
  transformIgnorePatterns: [
    ...
    'node_modules/(?!.*(jest-expo|react-native|@react-native|@react-navigation/.*|expo|@expo/.*|expo-router|expo-linking|expo-constants|expo-modules-core|react-native-reanimated|react-native-gesture-handler|react-native-safe-area-context|react-native-screens|expo-file-system|expo-image-manipulator|expo-camera|expo-image-picker|expo-media-library)/)',
  ],
